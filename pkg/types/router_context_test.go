...
var _ = Describe("RouterContext", func() {
	It("should initialize correctly", func() {
		...
		rctx := NewRoutingContext(ctx, "algorithm", "model", "message")
		...
		rctx2 := NewRoutingContext(ctx2, "algorithm2", "model2", "message2")
	...
	It("should HasRouted() indicate correctly", func() {
		ctx := NewRoutingContext(context.Background(), "algorithm", "model", "message")
